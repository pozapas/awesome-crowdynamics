...
| **Dense Crowd Dynamics and Pedestrian Trajectories: A Multiscale Field Dataset from the Festival of Lights in Lyon**   | The datasets referenced in this study in relation with dense pedestrian dynamics during the 2022 Festival of Lights in Lyon, France | [Access Link](https://doi.org/10.1038/s41597-025-04732-3)                                 | - Study, dashboard and Analysis Code are accessible  | Visit the access link to access the paper, description of the data and analysis code |
