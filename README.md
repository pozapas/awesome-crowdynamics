...
| **JuPedSim**     | An open-source framework for simulating pedestrian dynamics. It emphasises flexibility and prototyping of models on the tactical and strategical levels.                | [Documentation](https://www.jupedsim.org/stable/), [GitHub](https://github.com/PedestrianDynamics/jupedsim)    | - Several operational models<br> - C-API for coupling with other software like [SUMO](https://sumo.dlr.de/docs/Simulation/Pedestrians.html#model_jupedsim)<br> - Basic visualization tool| Open-Source   |
